...
CREATE INDEX idx_verifications_submission_id ON verifications(submission_id);
CREATE INDEX idx_verifications_ta_user_id ON verifications(ta_user_id);
...
-- Create gradebook table for tracking completed labs
...
-- Create indexes for gradebook
CREATE INDEX idx_gradebook_user_id ON gradebook(user_id);
CREATE INDEX idx_gradebook_lab_id ON gradebook(lab_id);
CREATE INDEX idx_gradebook_verified_at ON gradebook(verified_at);
